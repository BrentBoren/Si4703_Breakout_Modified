...
9/27/15 - Edited by Brent Boren. Implemented new readRDS method based on work by Martin Marinov (https://github.com/martinmarinov/AATMEGA644PandSi4703 )
 Also moved getChannel from private to public in header file.
...
#ifndef Si4703_Breakout_Modified_h
#define Si4703_Breakout_Modified_h
...
class Si4703_Breakout
{
  public:
	...
	int getChannel();				// returns the tuned channel or 0
